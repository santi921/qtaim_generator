...
we already cover the original's rich set of verticals. \revised{Hirshfeld, Becke and QTAIM
descriptors are cross-checked against HORTON and Critic2 on an 87-structure subset
(App.~\ref{app:xval}), but ADCH, ADC-Becke, CM5 and the fuzzy bond orders have a single
implementation (Multiwfn), and we did not benchmark against the commercial
AIMAll~\citep{aimall}.} Compute budget restricted
