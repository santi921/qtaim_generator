...
development~\citep{bamboo}, IBSI for bond-strength analysis~\citep{ibsi}). We do
not currently merge the energy and force values from the original work, though
this is an ongoing effort that could enable partial-charge-aware MLIPs.
