...
% ---- rebuttal revision tracking (2026-07-27) --------------------------------
% \revised{...} marks text added or corrected in response to the NeurIPS reviews.
% Longer revised blocks use \begingroup\color{revcolor} ... \endgroup.
% For a clean camera-ready, redefine as: \newcommand{\revised}[1]{#1}
% and delete the \color{revcolor} group markers.
\definecolor{revcolor}{RGB}{178,24,43}
\newcommand{\revised}[1]{\textcolor{revcolor}{#1}}

% ---- double-blind switch ------------------------------------------------------
% Identifying text (acknowledgments, facility names, affiliations) is wrapped in
% \ifanon <anonymous text> \else <camera-ready text> \fi. Set \anonfalse for camera-ready.
\newif\ifanon
\anontrue
...
train/val/test splits via \revised{a hashed molecular composition} and five
...
% \input{sections/06_noise_analysis}  % deferred -- pending noise floor results, will reinstate
