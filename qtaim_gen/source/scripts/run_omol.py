...
def main(): 
    ...
    parser.add_argument("-root_folder", type=str, default="/home/santiagovargas/dev/qtaim_generator/tests/test_files/omol")
        ...
        if os.path.isdir(folder_full_path):
            ...
            for order in order_of_operations:
                ...
                if os.path.exists(result_file) and os.path.getsize(result_file) > 0:
                    if not overwrite:
                        print("File {} already exists and is not empty".format(result_file))
                        continue
                
                mfwn_file = os.path.join(folder_full_path, "props_{}.mfwn".format(order))
