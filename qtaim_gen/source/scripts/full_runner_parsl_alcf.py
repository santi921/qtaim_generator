...
full-runner-parsl-alcf --num_folders 50000 --orca_2mkl_cmd $HOME/orca_6_0_0/orca_2mkl \
    --multiwfn_cmd $HOME/Multiwfn_3_8/Multiwfn_noGUI --clean \
        --full_set 0 --type_runner hpc --safety_factor 3.0 --move_results \
            ...
            --job_file ../jobs_by_topdir/orbnet_denali.txt --preprocess_compressed \
                ...
                --root_omol_inputs /lus/eagle/projects/OMol25/ --n_threads_per_job 1

full-runner-parsl-alcf --num_folders 50000 --orca_2mkl_cmd $HOME/orca_6_0_0/orca_2mkl \
    --multiwfn_cmd $HOME/Multiwfn_3_8/Multiwfn_noGUI --clean --full_set 0 --type_runner hpc \
        --n_threads 1 --safety_factor 1.0 --move_results --preprocess_compressed --timeout_hr 5 \
            --queue workq-route --restart --n_nodes 3 --type_runner hpc --job_file ../jobs_by_topdir/trans1x.txt \
